...
4) Sugar claim info recorded in markdown table format below 
...
5) Fat claim info of product images recorded in markdown table format below 
...
6) other claim list info recorded in markdown table format below 
...
7) calorie claim info recorded in markdown table format below:
(ROW RETURN CONDITION: only return row item if "does product explicitly claim this claim" value = true )
...
8) salt claim info recorded in markdown table format below:
(ROW RETURN CONDITION: only return row item if "does product explicitly claim this claim" value = true )
