...
TABLE FORMAT:
LABELING_INFO_ANALYSIS_TABLE
| label item | do label indicate product does not contamarkdin something? (answer is yes/no) | what are exactly things that product say not contain from the label item (split things by "/" for multiple if needed) |
| ------- | -------- | -------- |
