...
export const wholeGrainClaimValidator = async (
  ...
  console.log('start whole grain claim validator');
  ...
  console.log('whole grain claim validator -- finish');
};
...
const WHOLE_GRAIN_CLAIM_1 = {
  'whole gain': ['100% whole grains', '100% of the grain is whole grain'],
};
