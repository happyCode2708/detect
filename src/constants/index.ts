...
"nutrients": [{"name": string, "value": float?, "uom": string, "percentDailyValue": float,  "endSymbol": string? }],
"note": string,
"ingredients": string
'contain': string?,
}
...
10) Ingredients usually appear below or next to the nutrition panel and start right after "ingredients:" or "Ingredients:" or "INGREDIENTS:". 
...
14) For "Supplement Fact" there may be a special symbol such as "*" or "**" or "+", ... and the symbol exclude "%" right at position of "percentDailyValue". That symbol should be recorded as "endSymbol", For example "5%**" or "**" should be recorded as "endSymbol": "**"
...
15) The fact panel could be in the dual-column layout showing both "per serving" and "per container" information. Let's break down and separate into two different fact panels one is for 'per serving'
 and other for 'per container'. These two fact panels have the same value of "servingPerContainer", "note', "ingredients" and "contain"
