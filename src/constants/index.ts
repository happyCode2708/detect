...
export const makePrompt = ({ ocrText }: { ocrText?: string }) => {
  return `Some common constants:
+ FOOTNOTE_INDICATORS = ["*", "**", "†", "★★", "★"]
+ FAT_CONTAIN_CLAIM = ["zero grams trans fat per serving", "fat free"]
+ SALT_OR_SODIUM_CLAIMS = ["low sodium", "low salt"]
+ SUGAR_AND_SWEET_CLAIMS = ["no sugar alcohol"]
...
// "simpleOCRResult":  Can you please help me return only text on images not text on product, remember to ignore  all "\n"  in your answer?,
