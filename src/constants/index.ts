...
json
{
  "product": {
    ...
    "certificationOrLogo": "gemini help me list all certifiers logo/usda inspection marks on provided image?",
    "readAllConstants": "gemini please help me read carefully all constant above carefully. they are important and will be used to create the json output. And answer me did you read them?",
    "factPanels": null or  [
      {
        "panelName": string ,
...
// Ex: found text "bottle recyclable" next to a recyling logo so it should be recorded as
// {
//   "packagingDescriptors": ["bottle recyclable"]
// }

// "nonCertifiedClaims": string[],
// g) "attributesAndCertifiers.otherClaims.nonCertifiedClaims" rules:
// + is string array from enum NON_CERTIFIED_CLAIMS
// Ex 1: text "baked..." found so recorded as {"nonCertifiedClaims": ["baked"]}

// + returDo you see any USDA mark from provided image? return whole text of all USDA marks found on provided image.
// + is the string array of USDA info found on provided image
// + If you see any USDA mark from provided image, try to get the whole text of that USDA mark and add to "usdaStatements" list.
